...
*/
    ...
    public static Color MapColor(Color colorA, Color colorB, float x, float min, float max)
    {
        ...
        actual_r = Map(x, min, max, initialColor.r, finalColor.r);
        actual_g = Map(x, min, max, initialColor.g, finalColor.g);
        actual_b = Map(x, min, max, initialColor.b, finalColor.b);
        actual_a = Map(x, min, max, initialColor.a, finalColor.a);
